        ...
        <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="sm:col-span-2">
            ...
            <textarea
              ...
              rows={3}
              {...register('reason')}
              className={`${INPUT_BASE} ${errors.reason ? 'border-red-400' : ''}`}
